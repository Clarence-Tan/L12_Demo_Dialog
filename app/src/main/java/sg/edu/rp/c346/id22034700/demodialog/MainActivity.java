package sg.edu.rp.c346.id22034700.demodialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText etInputNum1 = viewDialog.findViewById(R.id.editTextInputNum1);
                final EditText etInputNum2 = viewDialog.findViewById(R.id.editTextInputNum2);
